...
.data
	...
	desc1	db	"Выполнить параллельное сравнение массивов по 3-и 64-разрядных вещественных числа. Если все числа второго массива больше первого, то выполнить поиск максимального значения, а если наоборот – то минимального.", 10, 10,
				"Результат = %d", 10,
				"Автор - Анисимов В.",0
