...
.data
    ...
    desc1   db  "Выполнить сравнение целых чисел 2-х массивов. Если один массив при первом цикле сравнения больше другого массива, то выполнить операцию a – e/c – ab, где a, b, c, d – вещественные числа; иначе – выполнить операцию ab.", 10, 10,
	            "Результат программы = %d", 10,
	            "Автор - Анисимов В.", 0
    tit1    db  "Анисимов Виктор, Y2438 ЛР №9", 0
    buf1    dq  ?, 0
